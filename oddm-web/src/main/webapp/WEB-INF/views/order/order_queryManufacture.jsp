...
<script type="text/javascript">
	...
	$(function() {
		$.ajax({
			url:"${ctx}/order/getManufacture?orderNo="+ orderNo,
			type:"POST",
			dataType: "json",
	...
	//变更记录
	$('#manufacturePrint').off('click').on('click',function(){
		$(this).attr('href','${ctx}/manufacture/printPage?id='+manufactureId);
...
<div>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="ordertable">
        <tr class="tabletitle">
            ...
            <b>一、基础信息：</b>
            <span>
	            <a id="manufactureAltList" class="clickCss">[变更记录]</a>
	            <a id="manufacturePrint" class="clickCss" >[打印]</a>
            </span>
            </td>
        </tr>
        <tr>
