		...
		parent.$.modalDialog({
			...
			buttons : [ {
				...
				handler : function() {
					...
					download_file("${ctx}/materialFollowup/excelExportAll?state="+materialFollowExcel+"&seller="+seller+"&clientName="+clientName+"&merchandiser="+merchandiser+"&dateOrderStart="+dateOrderStart+"&dateOrderEnd="+dateOrderEnd);
					parent.$.modalDialog.handler.dialog('close');
				}
			} ]
		});
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		<%-- <c:if test="${fn:contains(sessionInfo.resourceList, '/materialFollowup/allAdd')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/materialFollowup/allEdit')}">
		...
		<%-- <c:if test="${fn:contains(sessionInfo.resourceList, '/materialFollowup/allDelete')}">
		 ...
		 <c:if test="${fn:contains(sessionInfo.resourceList, '/materialFollowup/allExcel')}">
