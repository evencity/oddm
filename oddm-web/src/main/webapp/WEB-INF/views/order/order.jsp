...
<c:if test="${fn:contains(sessionInfo.resourceList, '/order/editablePerson')}">
	<script type="text/javascript">
		$.canEditable = true;
	</script>
</c:if>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/addNeworder')}">
			<a onclick="addNeworderFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">创建翻单</a>
		</c:if>
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/changeMerchandiser')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/changeSeller')}">
			<a onclick="changeSeller();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'">变更业务</a>
		</c:if>
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/showOrderFollowup')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/showBom')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/showDocument')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/showMaterialFollowup')}">
		...
		<c:if test="${fn:contains(sessionInfo.resourceList, '/order/showManufacture')}">
