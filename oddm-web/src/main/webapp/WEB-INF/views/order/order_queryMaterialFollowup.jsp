...
<script type="text/javascript">
	...
	$(function() {
		 $.ajax({
			url:"${ctx}/order/getMaterialFollowup?id="+ orderId,
			type:"GET",
			dataType: "json",
            			...
            			var $content = $('<table border="0" cellpadding="0" cellspacing="0" class="ordertable" >'+
            		       ...
            		       ' <tr>'+         
            		        ...
            		        '<tr>'+
            		            ...
            		            '<td class="righttd" colspan="3">'+ data[i].specification +'</td>'+
            		            '<td class="lefttd">整机物料齐套状况：</td>'+
            		            '<td class="righttd" colspan="3">'+ data[i].mtCondition +'</td>'+
            		       '</tr>'+
            		    '</table>');
	...
	<table border="0" cellpadding="0" cellspacing="0" class="ordertable">
        ...
        <tr>
           ...
           <td class="lefttd" width="10%">客户名称：</td>
            <td class="righttd" width="15%"><div id="clientName"></div></td> 
        </tr>
