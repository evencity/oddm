...
<script type="text/javascript">
	var dataGrid;
	var materialPackingIds = "${materialPackingIds}";
	$(function() {
		if(materialPackingIds != ""){
			var packingIds = materialPackingIds.split(',');
			for(var i in packingIds){
				var packing = packingIds[i].split('|');
				var content = '<li id='+ packing[0] +'>'+ packing[1] +'</li>'
