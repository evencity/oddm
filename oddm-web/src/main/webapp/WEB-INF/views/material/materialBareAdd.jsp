...
<div class="easyui-layout" data-options="fit:true,border:false" >
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
		<form id="materialBareAddForm" method="post">
			<table class="grid">
				<tr>
					<td>物料名称</td>
				...
				<tr>
					<td>类型</td>
					<td><select id="materialBareType" name="typeId" style="width: 140px; height: 29px;" class="easyui-validatebox" data-options="required:true,validType:['isBlank','length[0,64]']"></select></td>
				</tr>
				<tr>
					<td>基础物料</td>
