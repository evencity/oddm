...
<c:if test="${fn:contains(sessionInfo.resourceList, '/productType/edit')}">
	<script type="text/javascript">
		$.canEdit = true;
	</script>
</c:if>
<c:if test="${fn:contains(sessionInfo.resourceList, '/productType/delete')}">
	<script type="text/javascript">
	$.canDelete = true;
	</script>
</c:if>
