...
<script type="text/javascript">
	var dataGrid;
	var materialFittingIds = "${materialFittingIds}";
	$(function() {
		/* if(materialFittingIds != ""){
			var fittingIds = materialFittingIds.split(',');
			for(var i in fittingIds){
				var fitting = fittingIds[i].split('|');
				var content = '<li id='+ fitting[0] +'>'+ fitting[1] +'</li>'
