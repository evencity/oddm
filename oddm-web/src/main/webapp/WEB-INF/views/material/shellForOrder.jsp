...
<script type="text/javascript">
	var dataGrid;
	var materialBare_shellNames = "${shellNames}";
	$(function() {
		if(materialBare_shellNames != ""){
				var shellNames = materialBare_shellNames.split(',');
				for(var i in shellNames){
					var content = '<li >'+ shellNames[i].trim() +'</li>'
